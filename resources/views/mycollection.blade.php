    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 mt-3 mb-5 flex justify-content-center">
                <div class="col-md-6">
                    <h4 class="mr-3">Search My collection...</h4>
                    </div>
                <div class="col-md-6">
                    <form action="{{ route('mycollection.search', auth()->user()) }}" class="form-inline my-2 my-lg-0" method="get">
            ...
            @foreach($newsItems as $data)
                ...
                <div class="col-md-6 pl-4 mb-2">
                    <form action="{{ route('mycollection.delete', [$data->user, $data]) }}" method="post">
                        @csrf
                        @method('DELETE')
