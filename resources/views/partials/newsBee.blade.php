...
<div class="row mb-2 mt-2 p-4">
                
    <div class="col-md-8 pr-5">
            
        <div class="row mt-3 pl-3 mb-3 text-baseline">
            <h3>Status:</h3>
            <p class="ml-3 pt-2 font-weight-bold">{{ $data->status }}</p>
        </div>
    ...
    <div class="col-md-4 pl-2 d-flex align-items-center justify-content-center">
        @if( $data['image'] == !null )
